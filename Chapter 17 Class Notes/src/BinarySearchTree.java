...
{   
    ...
    */
    ...
    {   
        ...
        //we first have to check if the root if null
        if (this.root == null) {
            this.root = newNode;
        }
        else {
            this.root.addNode(newNode); //starting at the root
        }
    ...
    {   
        ...
        */
        ...
        { 
            ...
            // IF diif > 0, newNode is to the right of this node
            ...
            else if (diff > 0){ //because we do not want duplicates so we can't just use else
                if (right == null){
                    right = newNode;
                }
                else {
