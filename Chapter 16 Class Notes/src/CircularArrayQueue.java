...
public class CircularArrayQueue
{
    ...
    */
    public CircularArrayQueue()
    {
        ...
        head = 0;
        tail = 0;
        currentSize = 0; //because the queue is empty when created
    }
    ...
    */
    public void add(Object element)
    {
        ...
        this.tail++;
        // We have to reset the tail to 0 when it reaches the end of the array
    ...
    */
    public Object remove()
    {
        ...
        // We have to reset the head to 0 when it reaches the end of the array
